const pokemon = [
    ...
    attacks: [
      {
        ...
        name: 'Eruption',
        text:
          'Each player discards the top card of his or her deck. This attack does 20 damage times the number of Energy cards discarded in this way.',
        damage: '20×',
        convertedEnergyCost: 1
      },
      {
    ...
    attacks: [
      {
        ...
        name: 'Granite Head',
        text:
          "During your opponent's next turn, any damage done to Lairon by attacks is reduced by 10 (after applying Weakness and Resistance).",
        damage: '20',
        convertedEnergyCost: 2
      },
      {
  ...
  },
  {
    ...
    ability: {
      ...
      text:
        "As often as you like during your turn (before your attack), if Elekid is anywhere under Electivire, you may move a Lightning Energy attached to 1 of your Pokémon to Electivire. This power can't be used if Electivire is affected by a Special Condition.",
      type: 'Poké-Power'
    },
    hp: '100',
    retreatCost: ['Colorless', 'Colorless', 'Colorless'],
  ...
  },
  {
    ...
    set: 'Gym Heroes',
    setCode: 'gym1',
    text: ['Each player pays 1 more to retreat his or her Active Pokémon.']
  },
  {
    id: 'xy0-28',
    name: 'Skitty',
  ...
  },
  {
    ...
    ability: {
      name: 'Magical Return',
      text:
        "As often as you like during your turn (before your attack), you may return a Pokémon Tool card or Technical Machine card attached to your Pokémon to your hand. This power can't be used if Mismagius GL is affected by a Special Condition.",
      type: 'Poké-Power'
    },
    hp: '100',
    retreatCost: ['Colorless'],
    ...
    attacks: [
      {
        ...
        name: 'Darkness Magic',
        text:
          "Count the number of cards in your hand. Put that many damage counters on the Defending Pokémon. You can't put more than 8 damage counters in this way.",
        damage: '',
        convertedEnergyCost: 3
      }
    ],
  ...
  },
  {
    ...
    ability: {
      name: 'Security Guard',
      text:
        "As long as this Pokémon is your Active Pokémon, all of your Pokémon take 30 less damage from your opponent's attacks (after applying Weakness and Resistance).",
      type: 'Ability'
    },
    hp: '120',
    retreatCost: ['Colorless', 'Colorless', 'Colorless'],
  ...
  },
  {
    ...
    ability: {
      name: 'Frost Shift',
      text:
        "Once during your turn (before your attack), you may use this power. Frost Rotom's type is Water until the end of your turn.",
      type: 'Poké-Power'
    },
    hp: '90',
    retreatCost: ['Colorless', 'Colorless', 'Colorless'],
  ...
  },
  {
    ...
    attacks: [
      ...
      },
      {
        ...
        text:
          'Does 30 damage times the number of Pineco and Forretress you have in play. This attack does 30 damage to each of your Pineco and Forretress in play.',
        damage: '30×',
        convertedEnergyCost: 3
      }
    ],
    ...
    attacks: [
      {
        ...
        name: 'Cell Storm',
        text:
          'Discard 2 Psychic Energy attached to Deoxys and remove 6 damage counters from Deoxys.',
        damage: '60',
        convertedEnergyCost: 3
      }
    ],
  ...
  },
  {
    ...
    attacks: [
      ...
      },
      {
        ...
        name: 'Bone Impact',
        text:
          'If there is any Stadium card in play, this attack does 20 damage plus 60 more damage. Discard that Stadium card.',
        damage: '20+',
        convertedEnergyCost: 2
      }
    ],
    ...
    attacks: [
      {
        ...
        text:
          "Move up to 4 damage counters from any of your Pokémon to any of your opponent's Pokémon in any way you like.",
        damage: '',
        convertedEnergyCost: 1
      },
      {
  ...
  },
  {
    ...
    ability: {
      name: 'Wash Shift',
      text:
        "Once during your turn (before your attack), you may use this power. Wash Rotom's type is Water until the end of your turn.",
      type: 'Poké-Power'
    },
    hp: '90',
    retreatCost: ['Colorless', 'Colorless'],
    ...
    attacks: [
      {
        ...
        name: 'Volcano Stomp',
        text:
          "Flip a coin. If heads, discard the top 4 cards of your opponent's deck. If tails, discard the top 4 cards of your deck.",
        damage: '80',
        convertedEnergyCost: 4
      }
    ],
    ...
    attacks: [
      {
        ...
        name: 'Blessed Wings',
        text:
          'Remove all damage counters from each of your Pokémon. Shuffle Togekiss and all cards attached to it back into your deck.',
        damage: '',
        convertedEnergyCost: 2
      },
      {
  ...
  },
  {
    ...
    ability: {
      name: 'Retreat Aid',
      text:
        "As long as Dodrio is on your Bench, your Active Pokémon's Retreat Cost is ColorlessColorless less.",
      type: 'Poké-Body'
    },
    hp: '80',
    retreatCost: ['Colorless'],
